...
function render(lang, route) {
  ...
  if (route === "" || route === "village") {
    ...
    const mapArt = `<canvas class="map-picture" id="village-art" role="img" aria-label="${t.artAlt}"></canvas>`;
