...
function render(lang, route) {
  ...
  if (route === "" || route === "village") {
    ...
    const mapArt = `<picture class="map-picture"><source media="(min-aspect-ratio: 8/5)" srcset="/assets/village-wide.jpg" width="2172" height="724"><img class="map-art" src="/assets/village.jpg" alt="${t.artAlt}" width="1536" height="1024" fetchpriority="high"></picture>`;
